...
-- INSERT INTO treatment(id,name,description,cost) VALUES  (1,'Hair cut','A gramurous hair cut for your pet',20.0),
--                                                         (2,'Nail brushing','Get the nails of your pet in perfect state',35.0),
--                                                         (3,'Legs massage','Legs massage for your pet',100.0),
--                                                         (4,'Walk session','A walk session adapted to the fitness state of your pet',25.0),
--                                                         (5,'Wash','A wash for your pet',30.0),
--                                                         (6,'Nap','A long and repairing nap',10.0),
--                                                         (7,'Exam','General examination of the health state of your pet',12.0),
--                                                         (8,'Dental exam','We examine the tooth of your pet',15.0);

INSERT INTO grooming_type(id,name,description) VALUES  (1,'Hair cut','A gramurous hair cut for your pet'),
                                                        (2,'Nail brushing','Get the nails of your pet in perfect state'),
                                                        (3,'Legs massage','Legs massage for your pet'),
                                                        (4,'Walk session','A walk session adapted to the fitness state of your pet'),
                                                        (5,'Wash','A wash for your pet'),
                                                        (6,'Nap','A long and repairing nap');


INSERT INTO visits(id,pet_id,visit_date_time,description,vet_id,grooming_type_id) 
            VALUES  (1, 7, '2023-01-01 13:00', 'rabies shot', 4,1),
                    (2, 8, '2023-01-02 15:30', 'rabies shot', 5,3),
                    (3, 8, '2023-01-03 9:45', 'neutered', 5,5),
                    (4, 7, '2023-01-04 17:30', 'spayed', 4,5),
                    (5, 1, '2023-01-01 13:00', 'rabies shot', 1,6),
                    (6, 1, '2020-01-02 15:30', 'rabies shot', 1,2),
                    (7, 1, '2020-01-02 15:30', 'rabies shot', 1,2),
                    (8, 2, '2023-01-03 9:45', 'neutered', 2,5),
                    (9, 3, '2023-01-04 17:30', 'spayed', 3,3);
